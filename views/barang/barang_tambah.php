...
function BarisBaru()
{
	...
	Baris += "<td><input type='text' name='harga_jual[]' class='form-control input-sm' onkeypress='return check_int(event)'></td>";
	Baris += "<td><input type='text' name='harga_beli[]' class='form-control input-sm' onkeypress='return check_int(event)'></td>";
