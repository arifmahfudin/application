			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						...
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('barang/list-merek'); ?>">Daftar Merk</a></li>
						<li><a href="<?php echo site_url('barang/list-kategori'); ?>">Daftar Kategori</a></li>
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('barang/penyesuaian-stok'); ?>">Penyesuaian Stok</a></li>
					</ul>
				</li>
